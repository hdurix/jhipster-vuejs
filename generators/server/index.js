...
module.exports = class extends ServerGenerator {
    ...
    get initializing() {
        ...
        console.warn(chalk.yellow('❗❗❗ The authentication mechanism is forced to session until JWT is implemented on this blueprint ❗❗❗'));
        return super._initializing();
    }
    ...
    get prompting() {
        ...
        const myCustomPhaseSteps = {
            overrideAuthenticationTypeToSession() {
